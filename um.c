...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //init registers
    Registers all_registers = malloc(sizeof(struct Registers));
                          ...
                          Registers all_registers, uint32_t *counter)
{
    ...
    if (code == CMOV)
    {
        ...
        if (rC_val != 0)
        {
            ...
            uint32_t *word = UArray_at(all_registers->registers, rA);
            *word = rB_val;
    ...
    else if (code == ACTIVATE)
    {
       ...
       // set_register_value(all_registers, rB, mapped_index);
         uint32_t *word = UArray_at(all_registers->registers, rB);
         *word = mapped_index;
    }
    ...
    else if (code == IN)
    {
        ...
        if (input_value == all_ones)
        {
            ...
            uint32_t *word = UArray_at(all_registers->registers, rC);
            *word = all_ones;
    ...
    else if (code == LOADP)
    {
        ...
        uint32_t rB_val = *(uint32_t*)UArray_at(all_registers->registers, info->rB);
